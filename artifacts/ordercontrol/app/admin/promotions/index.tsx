...
const handleDelete = (id: string) => {
  Alert.alert("Remover promoção", "Tem certeza?", [
    {
      text: "Cancelar",
      style: "cancel",
    },
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      >
        ...
        {/* 🔥 ADD DESBLOQUEADO */}
        <Pressable
          onPress={() => router.push("/admin/promotions/new")}
      ...
      <FlatList
        ...
        renderItem={({ item }) => {
          const discount = item.promoPrice
            ? Math.round(
                ((item.price - item.promoPrice) / item.price) * 100
              )
            : 0;
          ...
          return (
            ...
            >
              <View style={styles.promoHeader}>
                ...
                >
                  <Text
                    style={[styles.discountText, { color: "#D97706" }]}
                  >
                    -{discount}%
                  </Text>
                </View>
                ...
                <Switch
                  ...
                  onValueChange={() => togglePromo(String(item.id))}
                />
              </View>
              ...
              <View style={styles.priceRow}>
                ...
                <View style={styles.priceBlock}>
                  ...
                  >
                    {formatCurrency(item.promoPrice ?? 0)}
                  </Text>
                </View>
                ...
                <View style={styles.priceBlock}>
                  ...
                  <Text
                    style={[styles.saving, { color: colors.success }]}
                  >
                    {formatCurrency(
                      item.price - (item.promoPrice ?? 0)
                    )}
                  </Text>
                </View>
              </View>
              ...
              <View style={styles.actions}>
                ...
                <Pressable
                  onPress={() =>
                    router.push({
                      pathname: "/admin/promotions/edit",
                      params: { id: item.id },
                    })
                  }
                  style={[
