...
import { CATEGORIES as INITIAL_CATEGORIES, PRODUCTS } from "@/data/restaurant";
...
export default function AdminCategoriesScreen() {
  ...
  // 🔥 SÓ ISSO FOI ADICIONADO (estado local)
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      <FlatList
        data={categories} // 🔥 ALTERADO (antes era CATEGORIES direto)
          ...
          return (
            ...
            >
              ...
              <View style={styles.catActions}>
                ...
                <Pressable
                  onPress={() => handleDelete(item.id)} // 🔥 ALTERADO
                  style={styles.actionBtn}
                >
                  <Feather
                    name="trash-2"
